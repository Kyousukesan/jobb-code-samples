...
import cn.dotfashion.soa.pim.client.vo.req.BatchSaveCategoryControlDetailRep;
import cn.dotfashion.soa.pim.client.vo.req.BatchSaveCategoryControlReq;
...
import cn.dotfashion.soa.pim.enums.FileExportType;
import cn.dotfashion.soa.pim.enums.LanguageEnum;
import cn.dotfashion.soa.pim.enums.MccSensitiveSceneEnum;
...
import cn.dotfashion.soa.pim.proxy.*;
import cn.dotfashion.soa.pim.service.AsyncBatchTaskService;
import cn.dotfashion.soa.pim.service.AsyncExportService;
import cn.dotfashion.soa.pim.service.category.audit.task.*;
import cn.dotfashion.soa.pim.task.CategoryAuditNotifyDelayTask;
import cn.dotfashion.soa.pim.task.CategoryAuditWechatDelayTask;
...
import cn.dotfashion.soa.pim.vo.request.sensitive.SensitiveWordVer3Req;
import cn.dotfashion.soa.pim.vo.response.BatchQueryCategoryNameResp;
...
//            pdsFrontCategoryClient.batchChangeStatus(batchChangeCategoryControlStatueReq);
    ...
    private Long doUbmpSubmit(CategoryAuditTaskEntity taskEntity) {
        ...
        workflowDoCreateDto.setRequestName("分类提报任务-" + taskEntity.getTopCategoryId() + "-" + taskEntity.getTaskSn());
